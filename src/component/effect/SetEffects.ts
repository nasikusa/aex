...
export default class SetEffects extends SetProperty {
  ...
  dropBlack(layer = this.selectedLayers[0]){
    ...
    layer.property("effect")(EF.byJa("チャンネルコンバイナー"))("ADBE Channel Combiner-0005").setValue(14);
    layer.property("effect")(EF.byJa("チャンネルコンバイナー"))("ADBE Channel Combiner-0006").setValue(4);
