...
export const HiraganaString = `あいうえお
かきくけこ
さしすせそ
たちつてと
なにぬねの
...
export const HiraganaDakuonString = `ゔ
がぎぐげご
ざじずぜぞ
だぢづでど
ばびぶべぼ`;

export const HiraganaHanDakuonString = `ぱぴぷぺぽ`;

export const HiraganaSmallString = `ぁぃぅぇぉ
っ
ゃゅょ
ゎ`;

export const KatakanaDakuonString = `ヴ
ガギグゲゴ
ザジズゼゾ
ダヂヅデド
バビブベボ
...
export const KatakanaHanDakuonString = `パピプペポ`;

export const KatakanaSmallString = `ァィゥェォ
ヵㇰヶ
ㇱㇲ
ッㇳ
ㇴ
...
export const HiraganaArray: string[] = _.str2Array(HiraganaString);

export const HiraganaArrayByColumn: string[] = _.getArrayDividedByLine(HiraganaString);

export const KatakanaString = `アイウエオ
カキクケコ
サシスセソ
タチツテト
ナニヌネノ
...
export const KatakanaArray: string[] = _.str2Array(KatakanaString);

export const KatakanaArrayByColumn: string[] = _.getArrayDividedByLine(KatakanaString);

export const JouyouKanjiString =
...
export const JinmeiKanjiString =
...
export const ZenkakuAlphabetSmallString = 'ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚ';

export const ZenkakuAlphabetBigString = 'ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ';

export const AlphabetSmallString = 'abcdefghijklmnopqrstuvwxyz';

export const AlphabetBigString = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';

export const NumberListString = '0123456789';

export const ZenkakuNumberListString = '１２３４５６７８９０';

export const HankakuKigouString = `!"#$%&'()-^\\@[;:],./\\=~|{+*}<>?_`;
